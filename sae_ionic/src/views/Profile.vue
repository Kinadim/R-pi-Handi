  ...
  <ion-page >
    ...
    <ion-content>
      ...
      <ion-card-header>
        ...
        <ion-card-subtitle>Date de naissance : {{ formatFrenchDate(user.birthdate) }}</ion-card-subtitle><br>
      </ion-card-header>
      <div class="btnLine">
        <ion-button  color="danger" class="logout" @click="deconnexion()"><ion-icon :icon="logout"/></ion-button>
