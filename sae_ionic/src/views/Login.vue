        ...
        <ion-content :fullscreen="true">
            ...
            <div id="container">
                ...
                <form @submit.prevent="login">
                    <ion-item>
                        <ion-input label="Adresse e-mail" label-placement="floating" v-model="email" type="email" required></ion-input>
                    </ion-item>
...
export default {
    ...
    methods: {
        ...
        async autoLog(){
            if(this.$store.getters.user !== undefined && this.$store.getters.user.mail !== undefined && this.$store.getters.user.password !== undefined){
                let newObj = {
