...
<script lang="ts">
import { IonContent, IonHeader, IonPage, IonToolbar, IonItem, IonInput, IonButton, IonToggle, IonCol, IonGrid, IonText, IonLabel, IonRow, IonTitle } from '@ionic/vue';
import { ref } from 'vue';
...
export default {
    ...
    components:{
      IonContent, IonHeader, IonPage, IonToolbar, IonItem, IonInput, IonButton, IonToggle, IonCol, IonGrid, IonText, IonLabel, IonRow, IonTitle
    },
    methods: {
      ...
      async loadData(){ //pre-write user's data
        ...
        this.birthdate = this.accData.birthdate.substring(0, 10);
