<template>
    ...
    <ion-content class="ion-padding">
        <ion-item>
            <ion-input  placeholder="Entrer le nom de l'évènement" v-model="event_Name" maxlength="32"></ion-input>
        </ion-item>
        <ion-item>
        ...
        <ion-button expand="block" class="custom-button" color="danger" :strong="true" v-if="!numberOfPAC">Maison de répis pleine</ion-button>
        <ion-item v-else>
            <ion-select label="Nombre de bénéficiaires" v-model="selectCapacite" @ionChange="handleChange(selectCapacite)">
...
<script>
import {IonContent,IonHeader,IonTitle,IonToolbar,IonPage,IonButtons,IonButton,IonItem,IonInput,modalController, IonSelect, IonTextarea, IonDatetime, IonSelectOption, IonLabel} from '@ionic/vue';
...
export default defineComponent({
    ...
    components:{
        IonContent,IonHeader,IonTitle,IonToolbar,IonPage,IonButtons,IonButton,IonItem,IonInput,modalController, IonSelect, IonTextarea, IonDatetime, IonSelectOption, IonLabel 
    },
    mounted() {
