<template>
    <ion-page class="main_page">
        ...
        <ion-content :fullscreen="true">
            ...
            <ion-item>
                <ion-textarea label="Description" label-placement="floating" v-model="desc"/>
            </ion-item>
            <ion-item>
                <ion-input label="Date de naissance" label-placement="stacked" v-model="birthdate" type="date" required></ion-input>
            </ion-item>
            <ion-item>
...
<script lang="ts">
import { IonContent, IonHeader, IonPage, IonToolbar, IonItem, IonInput, IonButton, IonCheckbox, IonTextarea, IonTitle, IonCol, IonGrid, IonRow, IonLabel } from '@ionic/vue';
